...
- **首页展示**：列出所有基金产品，显示基金经理信息
- **收益率脱敏**：首页收益率模糊处理，点击不清晰化
- **投资者验证**：手机号后四位登录，登录后只显示客户购买的产品
- **多产品支持**：购买多只基金的客户可在二级页面切换产品
- **基准对比**：净值走势与沪深300指数对比
...
|------|---------|--------|-----------|---------|
| 1 | 牛来 | 13501159554 | 晟孚泽鑫周期私募证券投资基金;晟孚泽鑫价值私募证券投资基金 | 2025.10.1 |
| 2 | 大灰狼 | 13881445263 | 晟孚泽鑫周期私募证券投资基金 | 2025.10.2 |

- 手机号为 11 位数字，系统自动提取后四位作为验证凭证
- 购买多只产品时，产品名称用分号（;）分隔
- 推送后自动生成 `clients.json` 供首页验证使用
